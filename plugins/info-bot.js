...
const estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "51966943496-61341576666@g.us" } : {}) },
message: { 
...
const estiloaudio = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "51966943496-61341576666@g.us" } : {}) },
message: { 
